/*!
 * @file Adafruit_HMC5883_2i2c.cpp
 *
 * @mainpage Adafruit HMC5883 2i2c Library
 *
...
int HMC5883L_ADDRESS_MAG = HMC5883L_ADDRESS;
/***************************************************************************
 MAGNETOMETER
 ***************************************************************************/
/***************************************************************************
...
*/
/**************************************************************************/
void Adafruit_HMC5883_2i2c::write8(byte address, byte reg, byte value) {
...
*/
/**************************************************************************/
byte Adafruit_HMC5883_2i2c::read8(byte address, byte reg) {
  byte value;
...
*/
/**************************************************************************/
void Adafruit_HMC5883_2i2c::read() {
  // Read the magnetometer
  Wi2c.beginTransmission((byte)HMC5883L_ADDRESS_MAG);
#if ARDUINO >= 100
  ...
  Wi2c.requestFrom((byte)HMC5883L_ADDRESS_MAG, (byte)6, true);
...
*/
/**************************************************************************/
Adafruit_HMC5883_2i2c::Adafruit_HMC5883_2i2c(int32_t sensorID) {
  _sensorID = sensorID;
}
...
*/
/**************************************************************************/
/*bool Adafruit_HMC5883_2i2c::begin() {
  // Enable I2C
  Wi2c.begin();

  // Enable the magnetometer
  write8(HMC5883L_ADDRESS_MAG, HMC5883_REGISTER_MAG_MR_REG_M, 0x00);
...
*/
/**************************************************************************/
bool Adafruit_HMC5883_2i2c::begin(uint8_t i2c_addr , TwoWire *wire ) {
	Wi2c = *wire;
  // Enable I2C
  Wi2c.begin();
  HMC5883L_ADDRESS_MAG = i2c_addr;
...
*/
/**************************************************************************/
void Adafruit_HMC5883_2i2c::setMagGain(hmc5883MagGain gain) {
  write8(HMC5883L_ADDRESS_MAG, HMC5883_REGISTER_MAG_CRB_REG_M, (byte)gain);
...
*/
/**************************************************************************/
bool Adafruit_HMC5883_2i2c::getEvent(sensors_event_t *event) {
  /* Clear the event */
...
*/
/**************************************************************************/
void Adafruit_HMC5883_2i2c::getSensor(sensor_t *sensor) {
