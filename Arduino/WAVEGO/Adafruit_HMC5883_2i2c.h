...
class Adafruit_HMC5883_2i2c : public Adafruit_Sensor {
public:
  /*!
   * @param sensorID sensor ID, -1 by default
   */
  Adafruit_HMC5883_2i2c(int32_t sensorID = -1);

  //bool begin(); //!< @return Returns whether connection was successful
  bool begin(uint8_t i2c_addr = HMC5883L_ADDRESS, TwoWire *wire = &Wire); //!< @return Returns whether connection was successful
